...
var game,
    ...
    var firstmove = function(){
        if( game.state=="running" && player.standing.opacity() && control.pressed("RIGHT") || control.pressed("LEFT") || control.pressed("A")){
